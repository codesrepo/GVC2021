...
| :------------------------ |:-------------:|
| API_docs |Documnetation related to running the IP protected codes via APIX API|
| codes |All the codes are placed in this folder|
| data |Sample data to run the end-2-end pipeline as well as  test data to generate the actual results |
