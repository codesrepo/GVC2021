...
if __name__ == '__main__':
    ...
    for metric in param_fairness['protected_attribute_list']:     
        new_obj = FairnessMaster(final,param_fairness['target'],param_UBR['score'],metric,param_fairness['privileged_group'],param_fairness['base_trheshold'],param_fairness['threshold_bins'])
        ...
        path_temp = param_UBR["out_path"]+"%s_UBR_fairness_report.csv"%(metric)
        print("..saving...%s_UBR_fairness_report.csv"%(metric))
